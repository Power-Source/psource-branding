(function ($) {
	...
	var Menu_Item_Container_Elements = function () {
		...
		this.select_all_checkbox = $('.pstoolkit-menu-select-all', this.builder_header);
		this.bulk_controls = $('.pstoolkit-custom-menu-bulk-controls', this.builder_header);
		this.duplicate_button = $('.pstoolkit-custom-admin-menu-duplicate', this.bulk_controls);
		this.make_invisible_button = $('.pstoolkit-custom-admin-menu-make-invisible', this.bulk_controls);
		this.make_visible_button = $('.pstoolkit-custom-admin-menu-make-visible', this.bulk_controls);
		this.hide_button = $('.pstoolkit-custom-admin-menu-hide', this.bulk_controls);
		this.unhide_button = $('.pstoolkit-custom-admin-menu-unhide', this.bulk_controls);
	};

	window.PSToolkit.Menu_Item_Container = function () {
		// Public methods
		this.get_el = get_el;
		...
		/**
		 * @type {PSToolkit.Menu_Item_Container}
		 */
		var self = this;
		...
		/**
		 * @param event
		 * @param duplicate {PSToolkit.Menu_Item}
		 */
		...
		function replicate_data() {
			...
			items.forEach(function (menu_item) {
				var new_id = PSToolkit.Menu_Utils.generate_random_menu_item_id();
		...
		function add_new_item() {
			var is_main = contains_main_items(),
				item_args = PSToolkit.Menu_Item_Model.get_defaults(is_main),
				new_id = PSToolkit.Menu_Utils.generate_random_menu_item_id();

			var new_item = new PSToolkit.Menu_Item(new_id, item_args, self);
			add(new_item);
